...
use getexec_core::{ExecutionOutcome, ModuleMetadata, ProtocolMetadata, ScanPlan, ScanRequest};
use getexec_modules::builtin_modules;
use getexec_output::{ConsoleReporter, OutputEvent, Reporter};
use getexec_protocols::builtin_protocols;
use getexec_runtime::RuntimeProfile;
use getexec_storage::{InMemoryWorkspaceStore, WorkspaceStore};
use getexec_targets::classify_target;
use std::collections::BTreeMap;

pub struct GetexecApp {
    config: AppConfig,
